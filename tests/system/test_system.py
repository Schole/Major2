...
class TestHomeView(TestCase):
    ...
    def test_get(self) -> None:
        ...
        with patch.object(
            ...
            self.assertEqual(
                response.url,
                f"/health_appointment/patient_home/{self.patient_id}"
            )
...
class TestPatientHomeView(TestCase):
    ...
    def test_get(self) -> None:
        ...
        self.assertEqual(
            len(configs["illnesses"]),
            len(Illness.objects.all())
        )

        self.assertEqual(
            len(configs["illness_categories"]),
            len(IllnessCategory.objects.all())
        )
...
class TestSelectIllnessView(TestCase):
    ...
    def test_get(self) -> None:
        ...
        configs = response.context.dicts[3]
...
class TestCheckAvailableAppointmentView(TestCase):
    ...
    def test_get(self) -> None:
        ...
        context = response.context.dicts[3]
        ...
        self.assertEqual(
            len(context["dict_gathered_appointments"]),
            18
        )
